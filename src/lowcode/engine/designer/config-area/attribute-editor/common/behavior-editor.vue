...
const source = [
  { key: Behavior.NORMAL, name: '普通', tips: 'NORMAL: 控件的基本功能均可操作' },
  { key: Behavior.DISABLED, name: '禁用', tips: 'DISABLED: UI呈现禁用效果的特定样式' },
  { key: Behavior.READONLY, name: '只读', tips: 'READONLY: 仅显示控件的预置数据的内容, 控件不可编辑' },
  {
    key: Behavior.HIDDEN,
    name: '隐藏',
