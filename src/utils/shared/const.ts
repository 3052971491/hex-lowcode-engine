export const __WillFetch__ = `function willFetch(vars, config) {
  // 通过 vars 可以更改查询参数
...
export const __FitHandler__ = `function fit(response) {
...
export const __DataHandler__ = `function didFetch(content) {
  // content.b = 1; 修改返回数据结构中的 b 字段为1
  return content; // 重要，需返回 content
};`;

export const __ErrorHandler__ = `function onError(error){
  // console.log(error);
  // 可以在这里做弹框提示等操作
};`;
