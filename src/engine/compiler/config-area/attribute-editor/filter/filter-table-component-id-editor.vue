<template>
  <form-Item-wrapper :label="t('el.property.Filter.tableComponentId')" :name="props.attribute" :option="option">
    <a-select v-model:value="modelValue" mode="tags" @change="handleChange"> </a-select>
  </form-Item-wrapper>
</template>
<script lang="ts" setup name="FilterTableComponentIdEditor">
...
const handleChange = (value: string[]) => {
  modelValue.value = value.length > 0 ? value[value.length - 1] : '';
};
</script>
